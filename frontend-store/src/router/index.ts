  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'browse-history', name: 'BrowseHistory', component: () => import('@/views/BrowseHistory.vue'), meta: { auth: true } },
        { path: 'orders/:orderNo', name: 'OrderDetail', component: () => import('@/views/OrderDetail.vue'), meta: { auth: true } },
      ],
    },
